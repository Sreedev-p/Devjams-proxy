...
if dark_mode:
    THEME = {
        ...
        "accent": "#DDA15E",
        "accent_hover": "#E8B478",
        "accent_active": "#BC6C25",
        "accent_text": "#283618",
        "button_shadow": "0 0 0 1px rgba(221, 161, 94, 0.15), 0 6px 20px rgba(221, 161, 94, 0.18)",
        "button_shadow_hover": "0 0 0 1px rgba(221, 161, 94, 0.25), 0 8px 26px rgba(221, 161, 94, 0.3)",
    ...
    THEME = {
        ...
        "accent": "#BC6C25",
        "accent_hover": "#A85D1E",
        "accent_active": "#8C4E1B",
        "accent_text": "#FEFAE0",
        "button_shadow": "0 1px 2px rgba(40, 54, 24, 0.08)",
        "button_shadow_hover": "0 4px 14px rgba(188, 108, 37, 0.28)",
        "card_shadow": "0 1px 3px rgba(40, 54, 24, 0.06)",
    }
